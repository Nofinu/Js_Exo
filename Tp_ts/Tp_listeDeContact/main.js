...
const btnModalAddContact = document.querySelector('#btnModalAddContact');
const btnModalModifContact = document.querySelector('#btnModalModifContact');
const inputsADD = document.querySelector('#formAddContact').querySelectorAll('input');
const inputsModif = document.querySelector('#formModifContact').querySelectorAll('input');
...
btnModalAddContact.addEventListener('click', (e) => {
    e.preventDefault();
...
btnModalModifContact.addEventListener('click', (e) => {
    e.preventDefault();
